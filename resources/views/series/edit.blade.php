        ...
        <form action="{{ route('series.update', $serie->id) }}"
            ...
            <div class="form-group mb-3">
                ...
                <textarea name="descricao"
                          class="form-control"
                          rows="4"
                          required>{{ $serie->descricao }}</textarea>
            </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text"
                               ...
                               class="form-control"
                               value="{{ $serie->classificacao_indicativa }}"
                               required>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="status" class="form-control" required>
                            ...
                            <option value="Em andamento"
                                {{ $serie->status == 'Em andamento' ? 'selected' : '' }}>
                                Em andamento
                            </option>

                            <option value="Finalizada"
                                {{ $serie->status == 'Finalizada' ? 'selected' : '' }}>
                                Finalizada
                            </option>
